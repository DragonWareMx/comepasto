...
<body style="background-color: #1DA3A8;">
    ...
    <div class="preheader"
        ...
        Revisa los detalles de tu compra en la tienda online de Comepasto.
    </div>
    <!-- end preheader -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">A continuación se muestra un resumen de tu pedido reciente. Si tienes
                                alguna pregunta o
                                inquietudes sobre tu pedido, por favor <a href="{{route('preguntas')}}">contáctanos</a>.
                            </p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                ...
                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="left" valign="top"
                                            ...
                                            <p>{{$sale->client->name}}<br>{{$sale->client->email}}<br>{{$sale->client->tel}}
                    ...
                    <tr>
                        <td align="center" bgcolor="#1DA3A8"
                            ...
                            <p style="margin: 0;">Recibiste este correo porque tenemos una solicitud de compra desde tu
                                cuenta. Si no fuiste tú quien llevó a cabo esta acción puedes ignorar este mensaje o
