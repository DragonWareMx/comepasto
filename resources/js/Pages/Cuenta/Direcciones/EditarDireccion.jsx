...
const EditarDireccion = () => {
    ...
    return ( 
        <>
                ...
                <Grid item xs={12} style={{padding:'25px',display:'flex',alignItems:'baseline',flexWrap:'wrap'}}>
                    ...
                    <Grid container direction="row" justify="space-between" style={{marginTop:20}}>
                        ...
                        <Grid item xs={12} sm={9} md={6} style={{marginTop:26}} id="edit-grid">
                            <Grid item xs={12} className="grid-gray-name">EDITAR DIRECCIÓN</Grid>
                            <Grid item xs={12} className="grid-white-info">
                                ...
                                <MuiThemeProvider theme={theme}>
                                    ...
                                    <a className="link-edit-info" style={{color:'#DD5656'}} onClick={handleClickOpen}>Eliminar dirección</a>
            ...
            >
                <DialogTitle id="alert-dialog-title" className="title-dialog">{"¿Estás seguro de que deseas eliminar esta dirección?"}</DialogTitle>
                <DialogActions>
...
EditarDireccion.layout = page => <Layout children={page} title="Comepasto - Direcciones" pageTitle="Direcciones" />
